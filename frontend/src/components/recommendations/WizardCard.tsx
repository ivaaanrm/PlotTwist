    ...
    <div className="flex flex-col gap-6 w-full max-w-lg mx-auto px-4">
      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-between text-xs text-muted-foreground">
          ...
          <span>{question.step} of {question.total_steps}</span>
        </div>
      ...
      {/* Question card */}
      <div className="rounded-2xl border bg-card p-6 shadow-sm flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="flex gap-2">
          <Input
            placeholder={question.options ? "Or type your own…" : "Type your answer…"}
            value={freeText}
